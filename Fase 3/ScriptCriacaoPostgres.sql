...
-- Alterar o proprietário das tabelas para bd2admin

-- Tabelas
ALTER TABLE UTILIZADORES OWNER TO bd2admin;
ALTER TABLE PALESTRANTES OWNER TO bd2admin;
ALTER TABLE ADMINISTRADORES OWNER TO bd2admin;
ALTER TABLE EMPRESAS OWNER TO bd2admin;
ALTER TABLE EVENTOS OWNER TO bd2admin;
ALTER TABLE DESPESAS OWNER TO bd2admin;
ALTER TABLE INSCRICOES OWNER TO bd2admin;
ALTER TABLE PAGAMENTOS OWNER TO bd2admin;

-- Índices
ALTER INDEX EVENTOS_DESPESAS_FK OWNER TO bd2admin;
ALTER INDEX DESPESAS_PALESTRANTES_FK OWNER TO bd2admin;
ALTER INDEX EMPRESAS_EVENTOS_FK OWNER TO bd2admin;
ALTER INDEX PALESTRANTES_EVENTOS_FK OWNER TO bd2admin;
ALTER INDEX INSCRICOES_EVENTOS_FK OWNER TO bd2admin;
ALTER INDEX UTILIZADORES_INSCRICOES_FK OWNER TO bd2admin;
ALTER INDEX EVENTOS_PAGAMENTOS_FK OWNER TO bd2admin;
ALTER INDEX INSCRICOES_PAGAMENTOS_FK OWNER TO bd2admin;
